...
/* harmony import */ var _modules_header_scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/header-scroll */ "./js/modules/header-scroll.js");
/* harmony import */ var _modules_scroll_to_feedback__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/scroll-to-feedback */ "./js/modules/scroll-to-feedback.js");
/* harmony import */ var _modules_about_as__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/about-as */ "./js/modules/about-as.js");
/* harmony import */ var _modules_footer_popup__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/footer-popup */ "./js/modules/footer-popup.js");
/* harmony import */ var _modules_phone_mask__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/phone-mask */ "./js/modules/phone-mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  if (_modules_modal__WEBPACK_IMPORTED_MODULE_2__["buttonOpen"]) {
    _modules_modal__WEBPACK_IMPORTED_MODULE_2__["buttonOpen"].addEventListener('click', function (evt) {
      return Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["modalOpenHandler"])(evt);
    });
  }
  if (_modules_scroll_to_feedback__WEBPACK_IMPORTED_MODULE_4__["scrollSection"]) {
    window.onscroll = function () {
      return Object(_modules_header_scroll__WEBPACK_IMPORTED_MODULE_3__["scrollHandler"])();
    };
  }
  if (_modules_scroll_to_feedback__WEBPACK_IMPORTED_MODULE_4__["scrollButton"]) {
    _modules_scroll_to_feedback__WEBPACK_IMPORTED_MODULE_4__["scrollButton"].addEventListener('click', function (evt) {
      return Object(_modules_scroll_to_feedback__WEBPACK_IMPORTED_MODULE_4__["scrollFeedbackHandler"])(evt);
    });
  }
  if (_modules_about_as__WEBPACK_IMPORTED_MODULE_5__["buttonMoreInfo"]) {
    _modules_about_as__WEBPACK_IMPORTED_MODULE_5__["buttonMoreInfo"].addEventListener('click', function (evt) {
      return Object(_modules_about_as__WEBPACK_IMPORTED_MODULE_5__["textHiddenHandler"])(evt, _modules_about_as__WEBPACK_IMPORTED_MODULE_5__["aboutParagraphs"]);
    });
  }
  Object(_modules_phone_mask__WEBPACK_IMPORTED_MODULE_7__["renderPhoneNumberMask"])();
  if (_modules_footer_popup__WEBPACK_IMPORTED_MODULE_6__["footerButtons"][0]) {
    _modules_footer_popup__WEBPACK_IMPORTED_MODULE_6__["footerPopupButtons"][0].addEventListener('click', function () {
      return Object(_modules_footer_popup__WEBPACK_IMPORTED_MODULE_6__["footerMenuHandler"])(0, 1);
    });
  }
  if (_modules_footer_popup__WEBPACK_IMPORTED_MODULE_6__["footerButtons"][1]) {
    _modules_footer_popup__WEBPACK_IMPORTED_MODULE_6__["footerPopupButtons"][1].addEventListener('click', function () {
      return Object(_modules_footer_popup__WEBPACK_IMPORTED_MODULE_6__["footerMenuHandler"])(1, 0);
    });
  }
...
/*!********************************!*\
  !*** ./js/modules/about-as.js ***!
  \********************************/
/*! exports provided: textHiddenHandler, buttonMoreInfo, aboutParagraphs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "textHiddenHandler", function() { return textHiddenHandler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buttonMoreInfo", function() { return buttonMoreInfo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aboutParagraphs", function() { return aboutParagraphs; });
var aboutAsTextContainer = document.querySelector('.about-as__text-wrapper');
var aboutParagraphs = aboutAsTextContainer.children;
var buttonMoreInfo = document.querySelector('.about-as__link');
var MAX_COUNT_PARAGRAPHS = 1;
var INDEX_HIDDEN_PARAGRAPH = 2;
var checkCount = function checkCount(arr) {
...
var textHiddenHandler = function textHiddenHandler(evt, arr) {
  evt.preventDefault();
...
/*!************************************!*\
  !*** ./js/modules/footer-popup.js ***!
  \************************************/
/*! exports provided: footerButtons, footerMenuHandler, footerPopupButtons */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "footerButtons", function() { return footerButtons; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "footerMenuHandler", function() { return footerMenuHandler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "footerPopupButtons", function() { return footerPopupButtons; });
var footerPopupContainers = document.querySelectorAll('.main-footer__categories-wrapper');
var footerButtons = document.querySelectorAll('.main-footer__categories-button');
var footerLists = document.querySelectorAll('.main-footer__categories-list');
var footerPopupButtons = document.querySelectorAll('.main-footer__categories-title-wrapper');
footerPopupContainers.forEach(function (item) {
  return item.classList.remove('main-footer__categories-wrapper--no-js');
});
var footerMenuHandler = function footerMenuHandler(indexOn, indexOff) {
...
var scrollHeader = document.querySelector('.main-header');
var sticky = scrollHeader.offsetTop;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalOpenHandler", function() { return modalOpenHandler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buttonOpen", function() { return buttonOpen; });
var modal = document.querySelector('.modal-feedback');
var buttonOpen = document.querySelector('.main-navigation__callback-button');
...
var focusableItems = getFocusable(modal);
var stopFocusBehindModal = function stopFocusBehindModal(evt) {
  if (evt.keyCode === 9) {
    var focusedItem = evt.target;
...
var stopListenerOnFocus = function stopListenerOnFocus(object, method) {
  object.addEventListener(method, function (evt) {
    evt.stopImmediatePropagation();
  });
};
var onModalEscDown = function onModalEscDown(evt) {
  if (evt.key === 'Escape') {
    evt.preventDefault();
    modalCloseHandler();
  }
...
function modalCloseHandler() {
  if (modal) {
    var modalForm = modal.querySelector('.modal-feedback__form');
...
var modalOpenHandler = function modalOpenHandler(evt) {
  evt.preventDefault();
  if (modal) {
    body.classList.add('feedback-form--open');
    var modalForm = modal.querySelector('.modal-feedback__form');
    var buttonClose = modal.querySelector('.feedback-form__button-close');
    var inputName = modal.querySelector('input[type="text"]');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderPhoneNumberMask", function() { return renderPhoneNumberMask; });
var form = document.querySelector('.feedback__form');
var renderPhoneNumberMask = function renderPhoneNumberMask() {
  [].forEach.call(document.querySelectorAll('input[name="user-number"]'), function (input) {
    ...
    function mask(evt) {
      ...
      var reg = matrix.substr(0, evt.target.value.length).replace(/_+/g, function (a) {
        return '\\d{1,' + a.length + '}';
      }).replace(/[+()]/g, '\\$&');
      reg = new RegExp('^' + reg + '$');
    ...
    form.addEventListener('change', function () {
      var phoneInput = document.querySelector('input[name="user-number"]');
...
/*!******************************************!*\
  !*** ./js/modules/scroll-to-feedback.js ***!
  \******************************************/
/*! exports provided: scrollFeedbackHandler, scrollButton, scrollSection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollFeedbackHandler", function() { return scrollFeedbackHandler; });
...
var scrollSection = document.querySelector('#feedback');
var scrollFeedbackHandler = function scrollFeedbackHandler(evt) {
  evt.preventDefault();
  if (scrollSection) {
